...
Type TToker
	...
	Const __keywords$="strict,superstrict,public,private,protected,short,int,float,double,long,string,object,ptr,var,varptr," + ..
		...
		"next,return,alias,rem,endrem,throw,assert,try,catch,finally,using,nodebug,incbin,endselect,endmethod," + ..
		"endfunction,endtype,endextern,endtry,endusing,endwhile,pi,release,defdata,readdata,restoredata,interface," + ..
